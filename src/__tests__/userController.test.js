...
describe('getAdmin', () => {
    test('should return all admins successfully', async () => { 
        const mockUsers = [
            { user_id: 1, name: 'Admin A', phone: '123456789', address: 'Address A', email: 'adminA@example.com', password: 'password123', role_id: 1 },
            { user_id: 2, name: 'Admin B', phone: '987654321', address: 'Address B', email: 'adminB@example.com', password: 'password456', role_id: 1 }
        ];
...
describe('updateAdmin', () => {
    test('should update admin successfully', async () => {
        const mockAdmin = { user_id: 1, name: 'Admin A', phone: '123456789', address: 'Address A', email: 'adminA@example.com', password: 'password123', role_id: 1 };
        ...
        expect(userService.updateAdmin).toHaveBeenCalledWith('1', { name: 'Admin A' }); 
    });
